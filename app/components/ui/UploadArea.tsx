            ...
            <div className="w-full max-w-2xl animate-float-in my-auto">
                ...
                <div className="text-center mb-6 sm:mb-10">
                    <div className="inline-flex items-center gap-3 mb-4 sm:mb-6">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-xl">
                            <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                            </svg>
                        </div>
                    </div>
                    <h1 className="text-2xl sm:text-4xl font-bold text-[var(--foreground)] mb-2 sm:mb-3">
                        GetDeck
                    </h1>
                    <p className="text-sm sm:text-lg text-[var(--foreground-muted)]">
                ...
                {isInitializing ? (
                    ...
                    >
                        <div className="flex flex-col items-center gap-4 sm:gap-6">
                            ...
                            {/* Text */}
                            <div className="text-center">
                                <p className="text-lg sm:text-xl font-semibold text-[var(--foreground)] mb-1 sm:mb-2">
                            ...
                            {/* Action Button */}
                            <button className="mt-2 px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 btn-interactive text-sm sm:text-base">
                                选择文件
                            </button>
                        </div>
                    </div>
