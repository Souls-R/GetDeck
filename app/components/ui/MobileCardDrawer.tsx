...
interface MobileCardDrawerProps {
    ...
    onDuplicateCard?: (cardIndex: number) => void;
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="relative flex">
                                        <button
                                            ...
                                            className={`px-3 py-1.5 text-sm rounded-l-lg font-medium transition-colors flex items-center gap-1.5 whitespace-nowrap ${
                                                isGeneratingDeckCode
                                ...
                                {showEditMenu && (
                                    <>
                                        ...
                                        <div className="absolute right-0 top-full mt-1 z-20 rounded-lg shadow-lg bg-[var(--card-bg)] border border-[var(--card-border)] min-w-[100px]">
                                            ...
                                            <button
                                                onClick={() => { onDuplicateCard?.(selectedCardIndex); setShowEditMenu(false); }}
                                                className="w-full px-3 py-2 text-sm text-left text-[var(--foreground)] active:bg-[var(--background-secondary)] transition-colors flex items-center gap-2"
                                            >
