                ...
                >
                    <div className="text-xs text-[var(--foreground)] space-y-2">
                        ...
                        {isMobile ? (
                            ...
                            <ul className="text-[var(--foreground-muted)] space-y-1">
                                <li>• <kbd className="px-1 py-0.5 rounded bg-[var(--background-secondary)] text-[10px]">Ctrl+V</kbd> 粘贴截图快速识别</li>
                                <li>• 长按并拖拽卡片边框可微调位置并重新识别</li>
                                <li>• 使用 <kbd className="px-1 py-0.5 rounded bg-[var(--background-secondary)] text-[10px]">↑</kbd><kbd className="px-1 py-0.5 rounded bg-[var(--background-secondary)] text-[10px]">↓</kbd><kbd className="px-1 py-0.5 rounded bg-[var(--background-secondary)] text-[10px]">←</kbd><kbd className="px-1 py-0.5 rounded bg-[var(--background-secondary)] text-[10px]">→</kbd> 键浏览卡片</li>
                                <li>• 在右侧列表查看卡片详情并生成卡组码</li>
                            </ul>
                        )}
