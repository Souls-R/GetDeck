            ...
            <div className="flex items-center gap-1 px-2 py-2 rounded-2xl bg-[var(--card-bg)] border border-[var(--card-border)] shadow-xl pointer-events-auto">
                ...
                <div className="relative">
                    ...
                    {showAboutTip && (
                        <div
                            ref={tooltipRef}
                            className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 sm:w-80 p-3 rounded-xl bg-[var(--card-bg)] border border-[var(--card-border)] shadow-xl animate-float-in pointer-events-auto max-sm:fixed max-sm:bottom-20 max-sm:left-1/2 max-sm:-translate-x-1/2 max-sm:w-[calc(100vw-2rem)]"
                        >
                    ...
                    {/* Arrow */}
                    <div className="max-sm:hidden absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-3 h-3 rotate-45 bg-[var(--card-bg)] border-r border-b border-[var(--card-border)]" />
                </div>
            )}
                </div>
            </div>
